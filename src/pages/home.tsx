...
function Home() {
    ...
    const handleDownloadCV = () => {
        const cvFilePath = '../../my-cv/Chamsedin-Azouz.pdf';
        const cvFileName = 'Chamsedin-Azouz.pdf';
            ...
            <main className='relative'>
                <header className={`header typo-from typo-from__header${isHeaderFixed ? ' sticky' : ' '}`}>
                    ...
                    <div className='typo-from__options'>
                        <a href='#home' onClick={(e) => handleScroll('about', e)} className='header-option'>About</a>
                        <a href='#about' onClick={(e) => handleScroll('services', e)} className='header-option'>Services</a>
                        <a href='#services' onClick={(e) => handleScroll('experiences', e)} className='header-option'>Experiences</a>
                        <button className='header-option__hire-button' onClick={handleEmailClick}>
                ...
                <section className='section section__1'>
                    ...
                    <div className='section__box1'>
                        ...
                        <div className='section__box1__button'>
                            <button className='button__download-cv' onClick={handleDownloadCV}>
                ...
                <section className='social-media'>
                    ...
                    <div className='social-media__container' onClick={() => window.open("https://wa.me/+21692448974", '_blank')}>
                        <div className='social-media__face social-media__face__front'>
                            <a href='#null' className='social-media__section'>
                                <img src='../../images/whatsapp.png' alt='whatsapp' className='social-media__image' />
                            </a>
                            <span id='about' className='typo-from typo-from__social'>Whatsapp</span>
                        </div>
                        <div className='social-media__face social-media__face__back'>
                            <p className='typo-from'>Go To URL</p>
                            <img src='../../images/external.png' alt="external" className='social-media__external-image' />
                ...
                <section id='start' className='section section__2'>
                    <div className="line line__x">
                        <div className="fixed fixed__x" style={{ top: `50%`, transform: `translateY(-50%) translateX(50%)`, marginTop: `${scrollPosition}px` }}>
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 50 50" style={{ marginBottom: '10px' }} className='svg-social' onClick={() => window.open("https://github.com/Chamesss", '_blank')}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 50 50" style={{ marginBottom: '10px' }} className='svg-social' onClick={() => window.open("https://www.linkedin.com/in/chamsedin-azouz-613a77245", '_blank')}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 50 50" style={{ marginBottom: '10px' }} className='svg-social' onClick={() => window.open("https://www.facebook.com/ChamseDin.Azouz/", '_blank')}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 50 50" className='svg-social' onClick={() => window.open("https://wa.me/+21692448974", '_blank')}>
                    ...
                    <div className="line line__y">
                        <div className="fixed fixed__y" style={{ top: `50%`, transform: `translateY(50%) translateX(0%)`, marginTop: `${scrollPosition}px` }}>
                            <span className="email-text" onClick={handleEmailClick}>Chamsedin.azouz@gmail.com</span>
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 50 50" style={{ marginLeft: '10px' }} className='svg-email'>
                    ...
                    <div className='level-1'>
                        <div className='level-1__container'>
                            <img src='../../images/level-1.gif' alt='gif' className="gifi" />
                        ...
                        <div className='grid'>
                            {technologies.map((tech, index) => (
                                ...
                                >
                                    ...
                                    <div id='services' dangerouslySetInnerHTML={{ __html: tech.svg }} className='svg-container' />
                    ...
                    <section id='experiences' className='section__tools'>
                        <div className='relative'>
                        ...
                        <footer>
                            <div className='space-between'>
                                <div className='row spaced__less'>
                                    ...
                                    <a href='#null' className='social-media__section' onClick={() => window.open("https://wa.me/+21692448974", '_blank')}>
