...
function Home() {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            const maxScroll = section.offsetTop + section.offsetHeight - 40;
            const currentScroll = window.pageYOffset - section.offsetTop + 20;
        ...
        <div >
            <main className='relative'>
                ...
                <section id='about' className='section section__2'>
                    ...
                    <div className="line-x" style={{ top: '0', left: '2%' }}>
                        <div className="fixed" style={{ top: `${scrollPosition + 200}px` }}>
                            AAA
                        </div>
                    </div>
